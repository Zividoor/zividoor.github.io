...
　![img](https://images2017.cnblogs.com/blog/1223704/201709/1223704-20170905095737960-458597655.png)
...
create or replace directory DATA_PUMP_DIR as 'D:\databak\';

select * from dba_directories;

```
expdp 'sys/app@JMC as sysdba' dumpfile=jmcdatabak.dmp directory
=DATA_PUMP_DIR schemas=CORE,MSTDATA,BASEPM,CSTMGMT,BOMMGMT,BPMGMT,PPMGMT,PRDCTPM
,INTEGRATION,JMCPP
```
...
```
impdp 'sys/app@JMCRESTORE as sysdba' dumpfile=databak.dmp direc
tory=DATA_PUMP_DIR schemas=CORE,MSTDATA,BASEPM,CSTMGMT,BOMMGMT,BPMGMT,PPMGMT,PRDCTPM
,INTEGRATION,JMCPP
```
